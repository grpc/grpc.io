...
code and a string error description. The server-side chooses the status it returns
for a given RPC. Applications should only use values defined below. 

The gRPC client and server-side implementations may generate and
