...
officially moved the Tonic project into the [gRPC Project](https://grpc.io)
under the [CNCF](https://cncf.io), and its repo has been moved to
[grpc/grpc-rust](https://github.com/grpc/grpc-rust).  We have been working
together to coordinate this over the last two years, and expect to continue to
work together in the future as well.
