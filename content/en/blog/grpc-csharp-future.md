...
See [Migrating gRPC services from C-core to ASP.NET Core](https://docs.microsoft.com/en-us/aspnet/core/grpc/migration) for more tips on how to migrate from Grpc.Core to grpc-dotnet.
